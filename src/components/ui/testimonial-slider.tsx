...
const testimonials: Testimonial[] = [
    {
        ...
        quote:
            "Je suis parti de zéro, aucune audience. J'ai suivi les modules dans l'ordre et utilisé les prompts Claude fournis pour écrire mon ebook et mes scripts. Neuf jours plus tard, première vente à 29€, puis 12 autres dans la foulée.",
        author: "Lucas M.",
    ...
    },
    {
        ...
        quote:
            "Avant je vendais un truc trop général, zéro vente. J'ai utilisé les prompts d'analyse de niche pour capter les mots exacts de ma cible. Résultat : un template Notion à 39€ qui part tout seul.",
        author: "Mehdi K.",
        context: "26 ans, Lyon",
    },
    {
        ...
        quote: "C'était mon seul blocage. Réglé en une soirée avec l'avatar, et les prompts de scripts me sortent mes idées de vidéos tout prêtes. Je publie 2 vidéos par jour depuis.",
        author: "Enzo T.",
    ...
    },
    {
        ...
        quote: "Je génère 30 scripts en une soirée avec les prompts Claude fournis. Ça m'a enlevé la partie que je détestais : écrire.",
        author: "Yanis A.",
    ...
    },
    {
        ...
        quote: "Je bosse dessus le dimanche entre deux partiels. Les prompts Claude font 80% du boulot, je valide et je poste. Premier mois : 640€ avec un pack de fiches.",
        author: "Léa P.",
    ...
    },
    {
        ...
        quote: "Paiement, livraison, relances : tout est automatisé, et les prompts d'automatisation m'ont même écrit mes emails de vente. Je me réveille avec des ventes, c'est bizarre au début.",
        author: "Inès B.",
