...
// Configuration
const SITE_NAME = "leomethod"
const SENDER_DOMAIN = "notify.leomethod.app"
const ROOT_DOMAIN = "leomethod.app"
...
const SAMPLE_PROJECT_URL = "https://leomethod.lovable.app"
...
const handler = createAuthEmailHandler({
  ...
  emails: {
    ...
    invite: {
      subject: 'Tu es invité à rejoindre leomethod',
      render: (data) =>
